-- CreateEnum
CREATE TYPE "Role" AS ENUM ('OWNER', 'BRANCH_MANAGER', 'CASHIER');

-- CreateEnum
CREATE TYPE "ItemSourceType" AS ENUM ('COMMISSARY_SUPPLIED', 'BRANCH_SOURCED', 'FINISHED_PRODUCT');

-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('SALE', 'PRODUCTION', 'STOCK_RECEIPT', 'ADJUSTMENT');
...
CREATE TABLE "Item" (
    ...
    "unit" TEXT NOT NULL,
    "minThreshold" DOUBLE PRECISION NOT NULL DEFAULT 10.0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductionRecipe_finishedItemId_ingredientItemId_key" ON "ProductionRecipe"("finishedItemId", "ingredientItemId");
...
-- AddForeignKey
ALTER TABLE "ProductionRecipe" ADD CONSTRAINT "ProductionRecipe_finishedItemId_fkey" FOREIGN KEY ("finishedItemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductionRecipe" ADD CONSTRAINT "ProductionRecipe_ingredientItemId_fkey" FOREIGN KEY ("ingredientItemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;
